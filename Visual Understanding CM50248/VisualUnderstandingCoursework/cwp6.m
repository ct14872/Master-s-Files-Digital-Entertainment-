function cwp6(p)  
    ...
    elseif p==2
        ...
        % Find the best F with the most inliers
    ...
    elseif p==3
        ...
        % These correspond to the extrinsics since they are uncalibrated
...
%             plotCamera('Location',loc2,'Orientation', orien2); hold off;
            ...
            % Plot reprojected vs actual points on the images
...
% Used to decompose E to get 2 projection matrices and find the best
% solution. Does not work optimally.
...
% Calculates the number of points in front of both cameras
...
% points3D are actually 4D (not in homogeneous coordinates)
    ...
    % of the cameras, from the calibrated projection matrices.
